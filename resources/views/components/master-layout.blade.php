...
<link rel="stylesheet" href="{{ asset('css/style.css') }}">
  ...
  <body>
      <nav class="navbar navbar-expand-sm navbar-dark bg-primary">
          <a class="navbar-brand" href="{{ route('accueil') }}">AGSM</a>
              ...
              @else
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownId">
                        <a onclick="event.preventDefault(); document.getElementById('deconnexion').submit()" class="dropdown-item" href="{{ route('logout') }}">Deconnexion</a>
      ...
      <footer>
          <div class="container-fluid bg-dark pt-4 pb-4">
              <div class="text-center text-white text-bold">
                  &copy; OpenShop 2021 | Tous droits réservés
